...
<!-- Bootstrap styles -->
<link rel="stylesheet" href="{SITEURL}/themes/{THEME}/css/bootstrap.min.css">
<!-- Generic page styles -->
<link rel="stylesheet" href="{SITEURL}/themes/{THEME}/css/style.css">
<!-- blueimp Gallery styles -->
<link rel="stylesheet" href="{SITEURL}/themes/{THEME}/css/blueimp-gallery.min.css">
<!-- CSS to style the file input field as button and adjust the Bootstrap progress bars -->
<link rel="stylesheet" href="{SITEURL}/themes/{THEME}/css/jquery.fileupload.css">
<link rel="stylesheet" href="{SITEURL}/themes/{THEME}/css/jquery.fileupload-ui.css">
<!-- CSS adjustments for browsers with JavaScript disabled -->
<noscript><link rel="stylesheet" href="{SITEURL}/themes/{THEME}/css/jquery.fileupload-noscript.css"></noscript>
...
<div class="container">
    ...
    <form id="fileupload" action="{SITEUTRL}" method="POST" enctype="multipart/form-data">
        ...
        <noscript><input type="hidden" name="redirect" value="http://www.enable-javascript.com/"></noscript>
...
<script src="{SITEURL}/themes/{THEME}/js/jquery.blueimp-gallery.min.js"></script>
<!-- The Iframe Transport is required for browsers without support for XHR file uploads -->
<script src="{SITEURL}/themes/{THEME}/js/jquery.iframe-transport.js"></script>
<!-- The basic File Upload plugin -->
<script src="{SITEURL}/themes/{THEME}/js/jquery.fileupload.js"></script>
<!-- The File Upload processing plugin -->
<script src="{SITEURL}/themes/{THEME}/js/jquery.fileupload-process.js"></script>
<!-- The File Upload validation plugin -->
<script src="{SITEURL}/themes/{THEME}/js/jquery.fileupload-validate.js"></script>
<!-- The File Upload user interface plugin -->
<script src="{SITEURL}/themes/{THEME}/js/jquery.fileupload-ui.js"></script>
<!-- The main application script -->
<script src="{SITEURL}/themes/{THEME}/js/main.js"></script>
<!-- The XDomainRequest Transport is included for cross-domain file deletion for IE 8 and IE 9 -->
<!--[if (gte IE 8)&(lt IE 10)]>
<script src="{SITEURL}/themes/{THEME}/js/cors/jquery.xdr-transport.js"></script>
<![endif]-->
</body>
</html>
